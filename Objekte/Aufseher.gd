...
func Navigation(delta):
	if darf_bewegen:
		...
		#var abstand: float = v_spieler_aufseher.length()
...
func _on_einleitung_tutorial_fertig():
	darf_bewegen = true # Replace with function body.
